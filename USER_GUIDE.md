...
`.deb` packages (`Kuiqr-2.4.2.3.10-linux-{amd64,arm64}.deb`) are on the release page for Debian/Ubuntu. On GNOME, install the [AppIndicator](https://extensions.gnome.org/extension/615/appindicator-support/) extension if the tray icon doesn't appear.
</details>

### Browser Extension (Chrome / Edge / Brave / Firefox)

1. Download `kuiqr-extension-2.4.2.3.10.zip` (or `kuiqr-firefox-2.4.2.3.10.zip`) from the [latest release](https://github.com/LarryXu2014/Kuiqr/releases/latest) and unzip it
