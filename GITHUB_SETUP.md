...
3. Choose tag: `v2.4.1.0`
4. Release title: `v2.4.1.0 — Kuiqr`
...
| File | Platform |
|------|----------|
| `kuiqr-extension-2.4.1.0.zip` | Chrome / Edge / Brave / Opera |
| `kuiqr-firefox-2.4.1.0.zip` | Firefox 109+ |
| `Kuiqr-2.4.1.0-mac-arm64.dmg` | macOS Apple Silicon (M1/M2/M3/M4) |
| `Kuiqr-2.4.1.0-mac-arm64.zip` | macOS Apple Silicon (zip format) |
| `Kuiqr-2.4.1.0-mac-x64.dmg` | macOS Intel |
| `Kuiqr-2.4.1.0-mac-x64.zip` | macOS Intel (zip format) |
| `Kuiqr-2.4.1.0-windows-x64.exe` | Windows x64 (portable, no install) |
...
6. **Upload these files** from your local `releases/` folder:
   - `kuiqr-extension-2.4.1.0.zip` (~84 KB)
   - `kuiqr-firefox-2.4.1.0.zip` (~84 KB)
   - `Kuiqr-2.4.1.0-mac-arm64.dmg` (~95 MB)
   - `Kuiqr-2.4.1.0-mac-arm64.zip` (~92 MB)
   - `Kuiqr-2.4.1.0-mac-x64.dmg` (~100 MB)
   - `Kuiqr-2.4.1.0-mac-x64.zip` (~97 MB)
   - `Kuiqr-2.4.1.0-windows-x64.exe` (~70 MB)
