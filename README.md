...
![Version](https://img.shields.io/badge/Version-2.4.1.2-green.svg)
...
> **Note:** Kuiqr runs in the background and lives in your system tray. On GNOME you may need the [AppIndicator](https://extensions.gnome.org/extension/615/appindicator-support/) extension for the tray icon to appear. A `.deb` package is also provided for Debian/Ubuntu-based distros (`Kuiqr-2.4.1.2-linux-{x64,arm64}.deb`).

### Chrome / Edge / Brave Extension

```bash
# Download and extract
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-extension-2.4.1.2.zip -o /tmp/kuiqr-extension-2.4.1.2.zip && unzip -q /tmp/kuiqr-extension-2.4.1.2.zip -d ~/kuiqr-extension && echo "Extension extracted to ~/kuiqr-extension — load it from chrome://extensions > Load unpacked"
```
...
curl -L "https://ghproxy.com/https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.2-mac-arm64.dmg" -o ~/Downloads/Kuiqr.dmg && open ~/Downloads/Kuiqr.dmg
```
...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------ |
| Chrome / Edge / Brave      | [kuiqr-extension-2.4.1.2.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-extension-2.4.1.2.zip)                           | 84 KB | Verified |
| Firefox (109+)             | [kuiqr-firefox-2.4.1.2.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-firefox-2.4.1.2.zip)                               | 84 KB | Verified |
| macOS (Apple Silicon)      | [Kuiqr-2.4.1.2-mac-arm64.dmg](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.2-mac-arm64.dmg)     | ~95 MB | Verified |
| macOS (Apple Silicon, ZIP) | [Kuiqr-2.4.1.2-mac-arm64.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.2-mac-arm64.zip)     | ~92 MB | Verified |
...
1. Download `kuiqr-extension-2.4.1.2.zip` and unzip it
...
1. Download `kuiqr-firefox-2.4.1.2.zip` and unzip it
...
cd extension && zip -r ../kuiqr-extension-2.4.1.2.zip . -x "*.DS_Store"
...
cd /tmp/ff-build && zip -r /path/to/kuiqr-firefox-2.4.1.2.zip . -x "*.DS_Store"
```
