...
```bash
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-arm64.dmg -o ~/Downloads/Kuiqr.dmg && open ~/Downloads/Kuiqr.dmg
```
...
```bash
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-x64.dmg -o ~/Downloads/Kuiqr.dmg && open ~/Downloads/Kuiqr.dmg
```
...
```powershell
Invoke-WebRequest -Uri "https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-windows-x64.exe" -OutFile "$env:USERPROFILE\Downloads\Kuiqr.exe"; Start-Process "$env:USERPROFILE\Downloads\Kuiqr.exe"
```
...
```bash
# x64
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-x86_64.AppImage -o ~/Downloads/Kuiqr.AppImage && chmod +x ~/Downloads/Kuiqr.AppImage && ~/Downloads/Kuiqr.AppImage
# arm64
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-arm64.AppImage -o ~/Downloads/Kuiqr.AppImage && chmod +x ~/Downloads/Kuiqr.AppImage && ~/Downloads/Kuiqr.AppImage
```

> **Note:** Kuiqr runs in the background and lives in your system tray. On GNOME you may need the [AppIndicator](https://extensions.gnome.org/extension/615/appindicator-support/) extension for the tray icon to appear. A `.deb` package is also provided for Debian/Ubuntu-based distros (`Kuiqr-2.4.1.3-linux-{x64,arm64}.deb`).

### Chrome / Edge / Brave Extension

```bash
# Download and extract
curl -L https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-extension-2.4.1.3.zip -o /tmp/kuiqr-extension-2.4.1.3.zip && unzip -q /tmp/kuiqr-extension-2.4.1.3.zip -d ~/kuiqr-extension && echo "Extension extracted to ~/kuiqr-extension — load it from chrome://extensions > Load unpacked"
```
...
curl -L "https://ghproxy.com/https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-arm64.dmg" -o ~/Downloads/Kuiqr.dmg && open ~/Downloads/Kuiqr.dmg
```
...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------ |
| Chrome / Edge / Brave      | [kuiqr-extension-2.4.1.3.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-extension-2.4.1.3.zip)                           | 84 KB | Verified |
| Firefox (109+)             | [kuiqr-firefox-2.4.1.3.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/kuiqr-firefox-2.4.1.3.zip)                               | 84 KB | Verified |
| macOS (Apple Silicon)      | [Kuiqr-2.4.1.3-mac-arm64.dmg](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-arm64.dmg)     | ~95 MB | Verified |
| macOS (Apple Silicon, ZIP) | [Kuiqr-2.4.1.3-mac-arm64.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-arm64.zip)     | ~92 MB | Verified |
| macOS (Intel)              | [Kuiqr-2.4.1.3-mac-x64.dmg](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-x64.dmg)         | ~100 MB | Verified |
| macOS (Intel, ZIP)         | [Kuiqr-2.4.1.3-mac-x64.zip](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-mac-x64.zip)         | ~97 MB | Verified |
| Windows (x64)              | [Kuiqr-2.4.1.3-windows-x64.exe](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-windows-x64.exe) | ~70 MB | Verified |
| Linux (x64, AppImage)      | [Kuiqr-2.4.1.3-linux-x86_64.AppImage](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-x86_64.AppImage) | ~90 MB | Verified |
| Linux (arm64, AppImage)    | [Kuiqr-2.4.1.3-linux-arm64.AppImage](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-arm64.AppImage) | ~90 MB | Verified |
| Linux (x64, .deb)          | [Kuiqr-2.4.1.3-linux-amd64.deb](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-amd64.deb) | ~90 MB | Verified |
| Linux (arm64, .deb)        | [Kuiqr-2.4.1.3-linux-arm64.deb](https://github.com/LarryXu2014/Kuiqr/releases/latest/download/Kuiqr-2.4.1.3-linux-arm64.deb) | ~90 MB | Verified |
...
1. Download `kuiqr-extension-2.4.1.3.zip` and unzip it
...
1. Download `kuiqr-firefox-2.4.1.3.zip` and unzip it
...
cd extension && zip -r ../kuiqr-extension-2.4.1.3.zip . -x "*.DS_Store"
...
cd /tmp/ff-build && zip -r /path/to/kuiqr-firefox-2.4.1.3.zip . -x "*.DS_Store"
```
