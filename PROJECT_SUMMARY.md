...
**Kuiqr** is a cross-platform QR code scanning suite with multiple deliverables:
...
│   └── icons/                       # PWA icons
│
├── kuiqr-extension-2.4.1.2.zip            # Packaged Chrome extension (70KB)
├── kuiqr-firefox-2.4.1.2.zip              # Packaged Firefox extension (71KB)
...
- **Key differences from Chrome version:**
  ...
  - `browser_specific_settings.gecko.id`: "kuiqr@kuiqr.app"
...
- **GitHub links:** Point to `https://github.com/kuiqr/kuiqr` (repo not created yet)
...
7. Extension zips packaged — kuiqr-extension-2.4.1.2.zip, kuiqr-firefox-2.4.1.2.zip
8. "Scan whole page" removed from popup (user requested)

## 5. What's PENDING

1. **Set up GitHub repository** — push to `LarryXu2014/Kuiqr`, create releases with binaries
...
- Chrome zip: `/Users/stit/WorkBuddy/2026-07-14-23-07-50/qr-scanner/kuiqr-extension-2.4.1.2.zip`
- Firefox zip: `/Users/stit/WorkBuddy/2026-07-14-23-07-50/qr-scanner/kuiqr-firefox-2.4.1.2.zip`
